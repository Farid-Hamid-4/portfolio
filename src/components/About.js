    ...
    return (
        <section id="about-section" className="section-margins">
            ...
            <div id="about-container">
                <p style={{ width: "80%" }}>Hey there! &#128075; I'm Farid Hamid, a recent graduate &#127891; from the University of Guelph with an Honours degree in Computer Science.<br/><br/>Growing up with a permanent disability has given me a unique perspective, and I understand the challenges that people with various accessibility needs face. My mission is to make the web more inclusive and user-friendly for everyone. I've put my coding skills to work by creating a Chrome extension that does something pretty cool; it can identify the contents of an image and give a summary for folks with visual impairments. It's all about making the digital world more accessible and connected.<br/><br/>When I'm not immersed in code, you'll find me listening to &#127911; music and diving into &#127918; video games. In fact, I've whipped up a web app using Spotify's API. It crafts personalized playlists based on the audio vibes of specific songs. After all, what better way to get to know someone than through their music taste? I've got a few playlists that reflect the musical landscape I listen to - take a peek and get to know me.</p>
